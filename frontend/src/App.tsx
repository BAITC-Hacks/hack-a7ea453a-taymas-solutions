              ...
              <section className="workspace">
                ...
                <aside className="inspector panel" id="inspector">
                  ...
                  <div className="inspector-scroll" id="copilot-panel" role="tabpanel" aria-labelledby="copilot-tab" hidden={inspectorTab !== 'copilot'}>
                    <CopilotSlot><CopilotPanel key={data.datasetId ?? data.source} data={data} selectedId={selectedId} onNavigate={navigateFromCopilot} onAnswer={receiveAnswer} /></CopilotSlot>
                  </div>
                </aside>
              </section>
